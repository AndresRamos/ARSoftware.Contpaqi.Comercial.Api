        ...
        if (jsonTypeInfo.Type == apiRequestBaseType)
            jsonTypeInfo.PolymorphismOptions = new JsonPolymorphismOptions
            {
                ...
                DerivedTypes =
                {
                    ...
                    new JsonDerivedType(typeof(CreaDireccionRequest), nameof(CreaDireccionRequest)),
        ...
        if (jsonTypeInfo.Type == apiResponseBaseType)
            jsonTypeInfo.PolymorphismOptions = new JsonPolymorphismOptions
            {
                ...
                DerivedTypes =
                {
                    ...
                    new JsonDerivedType(typeof(CreaDireccionResponse), nameof(CreaDireccionResponse)),
