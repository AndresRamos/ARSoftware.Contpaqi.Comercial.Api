        ...
        if (jsonTypeInfo.Type == apiRequestBaseType)
            jsonTypeInfo.PolymorphismOptions = new JsonPolymorphismOptions
            {
                ...
                DerivedTypes =
                {
                    ...
                    new JsonDerivedType(typeof(CreaDireccionClienteRequest), nameof(CreaDireccionClienteRequest)),
        ...
        if (jsonTypeInfo.Type == apiResponseBaseType)
            jsonTypeInfo.PolymorphismOptions = new JsonPolymorphismOptions
            {
                ...
                DerivedTypes =
                {
                    ...
                    new JsonDerivedType(typeof(CreaDireccionClienteResponse), nameof(CreaDireccionClienteResponse)),
