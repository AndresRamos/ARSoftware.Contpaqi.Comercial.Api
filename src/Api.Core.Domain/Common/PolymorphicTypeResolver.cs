        ...
        if (jsonTypeInfo.Type == apiRequestBaseType)
            jsonTypeInfo.PolymorphismOptions = new JsonPolymorphismOptions
            {
                ...
                DerivedTypes =
                {
                    ...
                    new JsonDerivedType(typeof(ActualizaDireccionClienteRequest), nameof(ActualizaDireccionClienteRequest)),
                    ...
                    new JsonDerivedType(typeof(ActualizarUnidadMedidaRequest), nameof(ActualizarUnidadMedidaRequest)),
                    ...
                    new JsonDerivedType(typeof(BuscarDireccionClienteRequest), nameof(BuscarDireccionClienteRequest)),
                    ...
                    new JsonDerivedType(typeof(BuscarUnidadesMedidaRequest), nameof(BuscarUnidadesMedidaRequest)),
        ...
        if (jsonTypeInfo.Type == apiResponseBaseType)
            jsonTypeInfo.PolymorphismOptions = new JsonPolymorphismOptions
            {
                ...
                DerivedTypes =
                {
                    ...
                    new JsonDerivedType(typeof(ActualizaDireccionClienteResponse), nameof(ActualizaDireccionClienteResponse)),
                    ...
                    new JsonDerivedType(typeof(ActualizarUnidadMedidaResponse), nameof(ActualizarUnidadMedidaResponse)),
                    ...
                    new JsonDerivedType(typeof(BuscarDireccionClienteResponse), nameof(BuscarDireccionClienteResponse)),
                    ...
                    new JsonDerivedType(typeof(BuscarUnidadesMedidaResponse), nameof(BuscarUnidadesMedidaResponse)),
